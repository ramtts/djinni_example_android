...
public:
    ...
    const djinni::GlobalRef<jclass> clazz { djinni::jniFindClass("com/djinni/android/TextboxListener") };
    const jmethodID method_update { djinni::jniGetMethodID(clazz.get(), "update", "(Lcom/djinni/android/ItemList;)V") };
