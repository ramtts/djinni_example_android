...
NativeSortItems::NativeSortItems() : djinni::JniInterfaceCppExt<::textsort::SortItems>("com/djinni/android/SortItems$NativeProxy") {}

using namespace ::djinni_generated;

CJNIEXPORT void JNICALL Java_com_djinni_android_SortItems_00024NativeProxy_nativeDestroy(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
...
CJNIEXPORT void JNICALL Java_com_djinni_android_SortItems_00024NativeProxy_native_1sort(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_items)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
...
CJNIEXPORT jobject JNICALL Java_com_djinni_android_SortItems_createWithListener(JNIEnv* jniEnv, jobject /*this*/, jobject j_listener)
{
    try {
